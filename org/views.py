    ...
    if req.method=="POST":
        ...
        """if User.objects.filter(username=user).exists():
            ...
            if pass1==pass2:
                ...
                tomail=req.POST['user']
                subject="welcome to organic farming online hub"
                body="Thank you for registered to this application," \
                     "We are ready to provide our services to you!"
                to=[tomail]
